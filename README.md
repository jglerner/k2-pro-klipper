...
This repository documents the engineering decisions, experiments, configurations, and workflows developed while using the **Creality K2 Pro** with **Klipper**.
...
* TN-001 — PLA Bedroom `PRINT_START` (Initial Draft)
